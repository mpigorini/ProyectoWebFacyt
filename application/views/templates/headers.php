            ...
            <div class="container nav-wrapper">
                ...
                <ul class="right hide-on-med-and-down" ng-show="isLoggedIn()">
                    ...
                    <span ng-show="!$parent.helpers">
                        <li class="tab tooltipped" data-position="bottom" data-delay="60" data-tooltip="Mostrar tarjetas de ayuda"><a ng-click="helpers()" style="font-weight: bold; font-size: 22px;">?</a></li>
                    </span>
                    <span ng-show="$parent.helpers">
                        <li class="tab tooltipped" data-position="bottom" data-delay="60" data-tooltip="Ocultar tarjetas de ayuda"><a ng-click="helpers()" style="font-weight: bold; font-size: 22px;">?</a></li>
                    </span>
                </ul>
                <!-- Mobile nav-bar -->
