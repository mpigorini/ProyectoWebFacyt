    <footer class="page-footer teal darken-1" style="cursor: default;">
      <div class="container">
        <div class="row">
          <div class="col l6 s12">
            <h5 class="white-text">Help Desk</h5>
            <p class="grey-text text-lighten-4">Proyecto final de la asignatura Desarrollo de Aplicaciones Web. FaCyT, UC.</p>
          </div>
