          ...
          <div layout="row">
            <div flex="20">
               <md-input-container  class="md-block">
                    ...
                    <md-select placeholder="Analista" ng-model="model.analyst"  style="min-width: 200px;">
                      <md-option ng-value="analyst" ng-repeat="analyst in analysts">{{analyst.name}}</md-option>
                    </md-select>
                </md-input-container>
            </div>
            <div flex="20" flex-offset="5">
             ...
             <div flex="5" flex-offset="5" layout-align="center center">
                <md-button ng-click= "getTicketsForAnalyst()" class="md-primary md-raised" >Consultar</md-button>
              </div>
          </div>
